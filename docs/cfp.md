...
<tr><td>Ruese report</td><td> 3-8 pages </td><td> Short summary of motivation + method + results </td><td>  Report of a:<br> &#x25CD; reproduction (original team and set-up); or<br> &#x25CD; reproducibility (different team, origianl set-up); or<br> &#x25CD; replication (different team and set up). </td></tr>
