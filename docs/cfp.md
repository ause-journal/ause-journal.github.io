...
{: .warning }
> **IMPORTANT:** If you are not submitting a standard _technical paper_ (as defined below), it is strongly recommeded you add the name of the paper type
...
<tr><td>Ruese report</td><td> 3-8 pages </td><td> Summary of motivation + method + results </td><td>Report of a:<ul><li>reproduction (original team and orginal set-up); or</li><li >reproducibility (different team, original set-up); or</li><li>replication (different team and different set up).</li></ul> </td></tr>
