...
<tr><td>Ruese report</td><td> 3-8 pages </td><td> Summary of motivation + method + results </td><td>  Report of a:<ul><li>reproduction (original team and set-up); or</li><li >reproducibility (different team, origianl set-up); or</li><li>replication (different team and set up).</li></ul> </td></tr>
